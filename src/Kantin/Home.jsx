          ...
          <nav className="navbar navbar-light bg-light">
            <div className="container-fluid">
              <form className="d-flex">
                <a href="Home.jsx" className="navbar-brand font-weight-bold">
                  <i class="fas fa-bars"></i>
                  <span className="ml-4">MyKantin</span>
                </a>
                <div className="input-group input-group-sm ml-5 mt-1">
                  <span className="input-group-text bg-search">
              ...
              <form className="d-flex justify-content-center">
                <span className>
                  <i className="fas fa-heart mr-4 jarak"></i>
                </span>
                <h6>
                  <span className="badge bg-notif mr-4 jarak">3</span>
                </h6>
                <a href="Home.jsx">
                  <img
